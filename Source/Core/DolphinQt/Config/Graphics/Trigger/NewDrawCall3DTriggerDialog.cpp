...
NewDrawCall3DTriggerDialog::NewDrawCall3DTriggerDialog(QWidget* parent) : QDialog(parent)
{
  CreateMainLayout();

  setWindowTitle(tr("New DrawCall3D Trigger"));
  setWindowFlags(windowFlags() & ~Qt::WindowContextHelpButtonHint);
}

const DrawCall3DGraphicsTrigger& NewDrawCall3DTriggerDialog::GetTrigger() const
{
  return m_trigger;
}

QString NewDrawCall3DTriggerDialog::GetName() const
{
  return m_name->text();
}

void NewDrawCall3DTriggerDialog::CreateMainLayout()
{
