...
constexpr Common::EnumMap<OpcodeDecoder::Primitive, PrimitiveType::TriangleStrip>
    gx_from_primitive_type{OpcodeDecoder::Primitive::GX_DRAW_POINTS,
                           OpcodeDecoder::Primitive::GX_DRAW_LINES,
                           OpcodeDecoder::Primitive::GX_DRAW_TRIANGLES,
                           OpcodeDecoder::Primitive::GX_DRAW_TRIANGLE_STRIP};
